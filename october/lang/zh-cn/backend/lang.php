<?php return [
    ...
    'list'                => [
        ...
        'delete_selected_success'   => '成功删除选择项', // 'column_switch_true' => '是',
        // 'column_switch_false' => '否',
        'column_switch_true'        => '开启',
        'column_switch_false'       => '关闭'
    ],
    'fileupload'          => [
        'attachment'        => '附件',
        'help'              => '添加标题和描述到附件',
    ...
    'form'                => [
        ...
        'preview_no_media_message'             => '无选中资料.',
    ...
    'media'               => [
        ...
        'empty_library'              => '资料库为空。请上传文件或新建文件夹。',
        'insert'                     => '插入',
