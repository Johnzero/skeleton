    ...
    <div class="app-container">
        ...
        <div class="table-container">
            ...
            >
                ...
                <el-table-column sortable label="上次登录时间" align="center">
                    <template slot-scope="scope">{{
                        parseTime(scope.row.last_login)
                    }}</template>
                </el-table-column>
                <el-table-column
                    sortable
        ...
        >
            ...
            <div slot="footer">
                <el-button size="small" @click="resetPasswordDialogVisible = false"
                    >取 消</el-button
                >
                <el-button size="small" type="primary" @click="handleResetPassword()"
                    >确 定</el-button
                >
            </div>
        </el-dialog>
        ...
        <permission-detail
            ...
            :permissionDetailData="permissionDetailData"
        ></permission-detail>

        <!-- 添加/修改用户 -->
        <user-detail
            ref="userDetail"
            :userDetailDialogData="userDetailDialogData"
        ></user-detail>
    </div>
</template>
<script>
