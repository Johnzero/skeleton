    ...
    <div class="app-container">
        ...
        <div class="table-container">
            <el-table ref="albumTable" :data="list" style="width: 100%" size="mini">
                ...
                <el-table-column label="相册预览图" prop="album_name" align="center">
        ...
        <album-detail
            ref="albumDetail"
            :albumDetailDialogData="albumDetailDialogData"
        ></album-detail>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        handleEditAlbum(row) {
            ...
            this.albumDetailDialogData.statusOptions = this.statusOptions;
            this.albumDetailDialogData.typeOptions = this.typeOptions;
            this.albumDetailDialogData.albumDetailTitle = '修改 "' + row.title + '" 相册';
